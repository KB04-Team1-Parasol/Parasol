				...
				<div class="col-lg-30 col-12 mb-4 mb-lg-0">
					<div class="custom-block bg-white shadow-lg">
						...
						<div class="row gx-lg-5">
							...
							<div class="text-end">
    							<button class="btn btn-dark" type="submit" style="font-weight: bold">검색</button>
  							</div>
						</form>
					</div>
				</div>
