						...
						<div
							...
							<div class="d-flex justify-content-center">
								...
								<div class="custom-block-topics-listing-info d-flex">
									<div>
										<span class="badge bg-design rounded-pill">${saving.savingNo}</span>
										<br>
										<div class="detail-width">
											<h3 class="mb-1">${saving.savingName}</h3>
										</div>
										<hr>
										<br>
										<div class="row mb-4">
											...
											<div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0"
												...
												<div class="custom-block bg-white shadow-lg ddetail-width">
													...
													<div class="d-flex justify-content-end">
														...
														<div>
															<h6 class="mb-2">${saving.savingPeriod}개월</h6>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0"
												...
												<div class="custom-block bg-white shadow-lg ddetail-width">
													...
													<div class="d-flex justify-content-end">
														...
														<div>
															<h6 class="mb-2">${saving.savingMax}만원 이내</h6>
														</div>
													</div>
												</div>
											</div>
