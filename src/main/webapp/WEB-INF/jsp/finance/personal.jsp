                                ...
                                <div class="d-flex">
	                                 <div class="custom-block-topics-listing-info d-flex">
                                        <div>
									        ...
									        <label class="btn btn-outline-warning mb-2" for="incomeUnder50">5천만원 이하</label>
									        <input type="radio" class="btn-check" autocomplete="off" id="income70s" name="income" value="2" required>
									        <label class="btn btn-outline-warning mb-2" for="income70s">7천만원대</label>
									        <input type="radio" class="btn-check" autocomplete="off" id="income90s" name="income" value="3" required>
									        <label class="btn btn-outline-warning mb-2"  for="income90s">9천만원대</label>
									        <input type="radio" class="btn-check" autocomplete="off" id="incomeOver100" name="income" value="4" required>
									        <label class="btn btn-outline-warning mb-2" for="incomeOver100">1억 이상</label><br>
										 	</p>
	                                     </div>
			                        </div>
                                </div>
     								...
     								<div class="custom-block-topics-listing-info d-flex">
                                        <div>
									        ...
									        <input type="radio" class="btn-check" autocomplete="off"  id="knowalot" name="understand" value="5" required>
									       	<label class="btn btn-outline-warning mb-2" for="knowalot">각종 파생 상품을 알고있다</label>
									        <input type="radio" class="btn-check" autocomplete="off"  id="knowhalf" name="understand" value="3" required>
									        <label class="btn btn-outline-warning mb-2" for="knowhalf">적당히 알고있다</label>
									        <input type="radio" class="btn-check" autocomplete="off"  id="knowless" name="understand" value="1" required>
									        <label class="btn btn-outline-warning mb-2" for="knowless">어디까지만 안다</label><br>
											<br>
	                                     </div>
                                   </div>
                                </div>
                                ...
                                <div class="d-flex">
     								<div class="custom-block-topics-listing-info d-flex">
                                        <div>
									        ...
									        <label class="btn btn-outline-warning mb-2" for="yesloss">손실 나도 수익이 나면 괜찮다</label>
									        <input type="radio" class="btn-check" autocomplete="off" id="noboth" name="lossprofit" value="3" required>
									        <label class="btn btn-outline-warning mb-2" for="noboth">손실은 부담스럽다</label>
									        <input type="radio" class="btn-check" autocomplete="off"id="noloss" name="lossprofit" value="1" required>
									        <label class="btn btn-outline-warning mb-2" for="noloss">수익이 나지 않아도 손실은 싫다</label><br>
											<br>
	                                     </div>
                                   </div>
                                </div>
	                                ...
	                                <div class="d-flex">
	     								<div class="custom-block-topics-listing-info d-flex">
	                                        <div>
										        ...
										        <label class="btn btn-outline-warning mb-2" for="fullknow">잘 알고 있다</label>
										        ...
										        <label class="btn btn-outline-warning mb-2" for="halfknow">조금 알고 있다</label>
										        ...
										        <label class="btn btn-outline-warning mb-2" for="lessknow">잘 모른다</label><br>
												<br>
		                                     </div>
	                                   </div>
	                                </div>
